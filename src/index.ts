      ...
      try {
        ...
        page.on("response", async (response: any) => {
          ...
          try {
            ...
            if (
              response.url().includes("https://deliveroo.hk/send_verification_code")
            ) {
            ...
            if (
              response.url().includes("https://deliveroo.hk/verify_code")
            ) {
        ...
        await page.evaluate((input: any) => (input.value = ""), phoneInputField); // Clear the input field
        await page.type('input[name="phone_number"]', accountDetails.phoneNumber);
        ...
        console.log(`coupon code ${accountDetails.couponCode} entered into the input field.`);
